...
def config_parser():
    ...
    parser.add_argument("--mode", type=str, default='train',
                        help='Experiment mode: train/validate')
    
    # Training Data Parameters
    parser.add_argument('--conv3d_layers', type=int, default=[1,  16,  32, 64, 128], nargs='+', help='Features for voxel module.')
    ...
    parser.add_argument("--h_dim", type=int, default=256,
                        help='Dimension of the fc hidden layer of the voxel encoder.')
    parser.add_argument("--p_h_dim", type=int, default=256,
                        help='Dimension of the fc hidden layer of the point encoder.')
    parser.add_argument("--p_l_dim", type=int, default=256,
                        help='Dimension of the latent vector of the point encoder.')
    ...
    parser.add_argument("--gen_start", default=0, type=int)
    parser.add_argument("--gen_stop", default=100, type=int)
